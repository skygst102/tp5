...
(function ($) {
    $.fn.extendPagination = function (options) {
        ...
        if (totalPage > 0) {
            var html = [];
            html.push('<div class="inf"><i><span>第1页，</span><span>共10页，</span><span>每页十条</span></i></div> <ul class="pagination">');
            ...
            html.push('<li class="disabled hidden"><a href="#">...</a></li>');
            html.push('<li class="next"><a href="#">下一页</a></li></ul>');
            $(this).html(html.join(''));

        	var changeCon=$(this).find('div.inf span');
			changeCon.eq(1).html('共'+totalCount+'页，');
			changeCon.eq(2).html('每页'+limit+'条');
            ...
            currentObj.click(function (event) {
                ...
                changeCon.eq(0).html('第'+$(this).text()+'页，');
                ...
                if (totalPage > showPage) {
                    ...
                    if (($(this).prev().attr('class'))
                        ...
                        if ($(this).text()!=1) {minPage = currPage - 1;};//2017年1月14日修复bug,点击1时有负数出现
